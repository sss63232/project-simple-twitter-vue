  ...
  <div id="register">
    ...
    <form class="w-100 text-align" @submit.prevent.stop="handleSubmit">
      ...
      <div class="form-label-group">
        ...
        v-model="account" // name="account" // type="text" //
        class="form-control" // autocomplete="username" // placeholder="帳號" //
        required // autofocus // /> //
      </div>
      //
      <div class="form-label-group">
        // <label for="name">名稱</label> // <input // id="name" //
        v-model="name" // name="name" // type="text" // class="form-control" //
        autocomplete="username" // placeholder="名稱" // required // autofocus
        // /> //
      </div>
      //
      <div class="form-label-group">
        // <label for="email">Email</label> // <input // id="email" //
        v-model="email" // name="email" // type="email" // class="form-control"
      ...
      //
      <div class="form-label-group">
        // <label for="password-check">密碼確認</label> // <input //
        id="password-check" // v-model="checkPassword" // name="checkPassword"
        // type="password" // class="form-control" // placeholder="密碼確認" //
        autocomplete="new-password" // required // /> //
      </div>
      //
